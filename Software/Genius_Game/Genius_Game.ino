...
//This code was modified by Cyber City Circuits for use with the Genius Game Kit.\


//set the pins where the buttons, LEDs and buzzer connect
int button[] = {5, 7, 10, 12};  //A is button[0], B is button[1], C is button[2], D is button[3]
int led[] = {6, 8, 9, 11};     //A is led[0], B is led[1], C is led[2], F is led[3]
...
int buzzerPin = 4;           //pin that the buzzer is connected to
